            ...
            <div className="x_image_wrapper">
              <div className="x_splash_overlay">
                <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                  <path fill="#213448" d="M47.5,-57.5C62.2,-47.2,75.2,-32.5,79.1,-15.2C83,2.1,77.8,22,67.1,37.5C56.4,53,40.2,64.2,22.7,69.3C5.2,74.4,-13.6,73.4,-30.4,67.1C-47.2,60.8,-62,49.2,-70.8,33.4C-79.6,17.6,-82.4,-2.5,-76.6,-19.6C-70.8,-36.7,-56.4,-50.8,-41,-59.8C-25.6,-68.8,-9.2,-72.7,4.9,-78.5C19,-84.3,32.8,-67.8,47.5,-57.5Z" transform="translate(100 100)" />
                </svg>
              </div>
              <img 
                src={testImage}
