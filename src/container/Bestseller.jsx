...
//   const infiniteProducts = [...dummyProducts, ...dummyProducts, ...dummyProducts];

//   // Group products into slides (6 products per slide)
//   const productsPerSlide = 6;
//   const slides = [];
//   for (let i = 0; i < infiniteProducts.length; i += productsPerSlide) {
//     slides.push(infiniteProducts.slice(i, i + productsPerSlide));
//   }
...
//             indicators={false}
//             interval={3000}
//             className="z_product-carousel"
//             prevIcon={<FaChevronLeft className="z_carousel-icon" />}
//             nextIcon={<FaChevronRight className="z_carousel-icon" />}
//             wrap={true}
//             pause={false}
//             touch={true}
//             onSelect={(index) => {
//               // Reset to middle set of slides when reaching the end
//               if (index === slides.length - 1) {
//                 setTimeout(() => {
//                   const carousel = document.querySelector('.carousel');
//                   if (carousel) {
//                     carousel.querySelector('.carousel-inner').style.transition = 'none';
//                     carousel.querySelector('.carousel-inner').style.transform = 'translateX(0)';
//                     setTimeout(() => {
